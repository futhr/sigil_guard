...
- [ ] M1.09 A2A predicate extension fields for `agent_request` and
      `agent_response`.
...
- [ ] M1.10 `_agent_trust`/`_agent_confirmation` metadata helpers with
      collision rules.
...
- [ ] M1.11 Digest computation module.
...
- [ ] M1.13 `Attestation.from_decision/3`.
  ...
  - Tests: negative, malformed.
- [ ] M1.14 Golden vectors for all eight statement types.
...
- [ ] M1.19 Coverage trend gate in CI.
...
- [ ] M2.03 `TrustBundle.Verify` pipeline: roles, thresholds, expiry,
      revocations.
...
- [ ] M2.04 `TrustBundle.Cache` ETS snapshot with floor semantics.
  - Spec: `docs/specs/SP.02-embedded-trust-bundles.md` - Public API Sketch
    (Cache).
...
- [ ] M2.05 `TrustBundle.Quarantine` failure records.
  - Spec: `docs/specs/SP.02-embedded-trust-bundles.md` - Public API Sketch
    (Quarantine).
...
- [ ] M2.08 Trust-bundle golden fixtures and digests.
...
- [ ] M2.09 Negative verification matrix.
  ...
  - Tests: negative, tamper, expiration, malformed.
- [ ] M2.10 Rollback and floor tests.
  - Spec: `docs/specs/SP.02-embedded-trust-bundles.md` - Role Model And
...
- [ ] M2.11 Root-rotation chain walk from the pinned genesis root.
...
- [ ] M2.12 Forked-chain and rotation-replay rejection.
  - Spec: `docs/specs/SP.02-embedded-trust-bundles.md` - Emergency Rotation
...
- [ ] M2.14 `dev_bundle/1` library-mode bootstrap with doctest.
...
- [ ] M2.15 No-network guarantee tests.
  - Spec: `docs/specs/SP.02-embedded-trust-bundles.md` - Loading Sources
